...
About <span style="color: red">3,996 pages</span> were modified and roughly <span style="color: red">85 user scripts</span> were overwritten. Wikimedia engineers temporarily disabled editing across Wikipedia projects, reverted the malicious changes, suppressed the altered pages and scripts from edit histories, and restored affected content. The code was active for about <span style="color: red">23 minutes</span>, and Wikimedia reported no evidence of an external attack or data breach.
