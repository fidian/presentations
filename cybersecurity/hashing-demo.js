...
Typing anything into here changes the numbers below. It's possible to have a conflict (two values that have the same computed hash) much more easily with MD5. Most current computer algorithms use SHA256 or SHA512.</textarea
            ...
            <div class="result" style="font-size: 0.25em">
                SHA512: {{ sha512 }}
            </div>
        `
    },
    class {
        ...
        updateDelayed() {
            setTimeout(() => {
                ...
                this.updateMd5(value);
                this.updateSha1(value);
                this.updateSha256(value);
                this.updateSha512(value);
            });
        }
        ...
        updateSha1(value) {
            ...
            crypto.subtle.digest("SHA-1", data).then((hash) => {
                this.sha1 = this.arrayBufferToHex(hash);
            });
        }
        ...
        updateSha256(value) {
            ...
            crypto.subtle.digest("SHA-256", data).then((hash) => {
                this.sha256 = this.arrayBufferToHex(hash);
            });
        }
        ...
        updateSha512(value) {
            ...
            crypto.subtle.digest("SHA-512", data).then((hash) => {
                this.sha512 = this.arrayBufferToHex(hash);
            });
        }
